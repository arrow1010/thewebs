...
setInterval(function(){ 
			...
			if( activePosition < 3) {
				nextSlide($('.cd-hero-slider'), $('.cd-slider-nav'), activePosition+1);
				updateNavigationMarker(activePosition+1);
		...
		container.find('.cd-bg-video-wrapper').each(function(){
			...
			if( videoWrapper.is(':visible') ) {
				...
				var	videoUrl = videoWrapper.data('video'),
					video = $('<video loop><source src="'+videoUrl+'.mp4" type="video/mp4" /><source src="'+videoUrl+'.mp4" type="video/webm" /></video>');
